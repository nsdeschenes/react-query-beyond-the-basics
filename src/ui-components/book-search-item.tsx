...
export function BookSearchItem({
  ...
  return (
    <div className="flex items-start space-x-4 rounded-xl bg-gray-800 p-4 shadow transition hover:shadow-lg">
      {!isLoaded && (
      ...
      <div className="flex flex-col justify-start">
        ...
        <p className="mt-2 text-xs text-gray-500">Published in {publishYear}</p>
      </div>
    </div>
  )
}
